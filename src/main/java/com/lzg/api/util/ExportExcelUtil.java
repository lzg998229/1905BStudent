...
public class ExportExcelUtil {
     ...
     */
    public static  String exportExcel(ExcelUtilBean bean,Class clazz) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        //声明工作薄
    ...
    public static  String createMkdir(ExcelUtilBean bean){
        ...
        //获取项目在你电脑硬盘的绝对路径
        //d://tomcat/ssm/
        String realPath="E:\\zlkh\\day5\\springboot_student_html\\src\\main\\webapp";
